...
<div class="form-group col-12 text-right">
  {!! Form::open(['route' => ['restaurantsPayouts.create'], 'method' => 'create']) !!}
  {!! Form::button('حفظ<i class="fa fa-save"></i>  </button>', [
  'type' => 'submit',
  'class' => 'delete btn btn-success pull-right',
  'onclick' => "return confirm('هل متاكد من عملية متابعه عملية الدفع؟')"
  ]) !!}
{!! Form::close() !!}
